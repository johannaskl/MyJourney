      ...
      <div className="mb-8">        
        ...
        <section className="text-base max-w-3xl mx-auto text-left space-y-3">
          <div>
            ...
            <p className="italic text-pink-600">Augusti 2024 – Juni 2026</p>
            <a href="https://ecutbildning.se/utbildningar/frontendutvecklare/" target="_blank" rel="noopener noreferrer" className="underline hover:text-pink-600">
