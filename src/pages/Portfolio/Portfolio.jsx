  ...
  return (
    <div className="flex flex-col items-center justify-center text-center px-4">
      <div className="my-11 flex flex-col md:flex-row items-center justify-center md:space-x-10 lg:space-x-28">
        <h2 className="text-xl font-medium mb-6 md:mb-0 text-nowrap">Portfolio</h2>
        ...
        <section className="text-base max-w-xl mx-auto text-left sm:text-justify space-y-3">
          <div>
            ...
            <p className="text-base mx-auto">
              Tic-Tac-Toe är ett klassiskt, interaktivt spel där användaren kan spela mot en dator. Datorn gör smarta drag baserat på strategiska överväganden, såsom att försöka vinna, blockera spelarens drag eller välja slumpmässiga drag om det inte
              finns någon omedelbar hotbild.
            </p>
          </div>
